...
namespace qtl
{
    ...
    struct bind_string_helper
    {
            ...
            void assign(const char_type* str, size_t n)
            {
                m_value.assign(str, n);
            }
...
#define QTL_ARGS_TUPLE(Arg, Others) \
    ...
    class base_database
    {
        ...
        protected:
            struct nothing
            {
                template<typename... Values> bool operator()(Values&& ...) const
                {
                    return true;
                }
            };
            struct first_record
            {
                    ...
                    template<typename... Values> bool operator()(Values&& ...)
                    {
                        _found = true;
                        return false;
                    }
